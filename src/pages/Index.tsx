      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/noticias" className="text-madrid-navy hover:text-madrid-gold flex items-center">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/jugadores" className="text-madrid-navy hover:text-madrid-gold flex items-center">
      ...
      <section className="py-16 bg-madrid-navy text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/trofeos" className="text-white hover:text-madrid-gold flex items-center">
